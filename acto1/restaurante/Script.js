...
const dialogos = [
    ...
    '2. Bueno... Michael era reservado, pero últimamente lo notaba preocupado. Me comentó algo sobre unos problemas con un socio nuevo... un hombre al que le debía dinero.',
    '1. ¿Recuerda el nombre de ese hombre?',
    '2. Si, se llamaba Edgard Mindguard o algo asi, lo puede encontrar en un club del centro seguramente, es un borracho de mal caracter... creo que tiene atecedentes penales por violencia callejera.',
...
function editarTexto(event) {
    if (aux <= size - 1) {
        ...
        console.log(aux)
        if (aux === 23) {
            localStorage.setItem('clubEdgard', true)
