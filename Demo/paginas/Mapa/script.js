...
function PACasaAmigoOver() {
    document.getElementById("aviso").style.display = 'flex';
    document.getElementById("aviso").innerHTML = '<h1> CASA DEL AMIGO DE LA VICTIMA </h1>'
}
...
function verZonas(){
    ...
    if(localStorage.getItem('Epolicia') != null){
        estacionpolicia.style.display = 'block';
    }else{
        estacionpolicia.style.display = 'none';
    }
